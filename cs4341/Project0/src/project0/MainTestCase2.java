...
public class MainTestCase2 {
	...
	public static void main(String[] args) 
	{
		...
		Cell[] row1 = {new Cell(false, false, false, true, 0, 0, null, new Point(1,0)),
					   ...
					   new Cell(false,  false,  false, true, 0, 0,null,new Point(1,3)),
		...
		Cell[] row0 = {new Cell(false, false, false, true, 0, 0, null,new Point(0,0)),
				...
				new Cell(false,false,false,true,0,0,null, new Point(0,4))};
